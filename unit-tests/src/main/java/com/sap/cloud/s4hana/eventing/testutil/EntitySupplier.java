...
public class EntitySupplier {
	...
	static {
		...
		defaultCalendar.setTimeInMillis(1520434516000L);
	}
	...
	public static BusinessPartnerAddress getDefaultAddress() {
		return BusinessPartnerAddress.builder()
				...
				.businessPartner("9876543210")
				.person("Prof. Dr.-Ing. habil. Jöhn Schurnikidze-Popugaichikov Jr.")
				.streetName("Very long street name "
						+ "who knows how long could they be")
				.houseNumber("100/500 bldg. 77 corp. 8A")
				.houseNumberSupplementText(
						"It is indeed should be bldg. 77 corp. 8A "
						+ "and not bldg. 88 corp. 7A please also "
						+ "not confuse with bldg. 77 corp. 84")
				...
				.validityStartDate(defaultCalendar)
				.validityEndDate(defaultCalendar)
	...
	public static BPContactToFuncAndDept getQualityOfficerContact() {
        return BPContactToFuncAndDept.builder()
                ...
                .businessPartnerPerson("0000000001")
                .emailAddress("contact@example.com")
                .contactPersonFunction(CustomBusinessPartnerService.QUALITY_OFFICER)
                .build();
	}
    ...
    public static BPContactToFuncAndDept getQualityAssuranceContact() {
        return BPContactToFuncAndDept.builder()
                ...
                .businessPartnerPerson("0000000001")
                .emailAddress("contact@example.com")
                .contactPersonDepartment(CustomBusinessPartnerService.QUALITY_ASSURANCE)
                .build();
    }
