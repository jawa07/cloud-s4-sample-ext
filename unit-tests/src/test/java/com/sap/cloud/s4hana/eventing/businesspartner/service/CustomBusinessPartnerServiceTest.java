...
public class CustomBusinessPartnerServiceTest {
    ...
    @Mock
    private BusinessPartner businessPartnerMock;
    ...
    public void testGetByKey() throws ODataException {
        ...
        BusinessPartner newBusinessPartner = testee.getByKey(businessPartner.getBusinessPartner());
    ...
    public void testGetRootByKeyWithException() throws ODataException {
        ...
        // When CustomBusinessPartnerService is called
        BusinessPartner newBusinessPartner = testee.getRootByKey(businessPartner.getBusinessPartner());
    ...
    public void TestgetBupaAddress() throws ODataException {
        // Given dummy entities ...
        BusinessPartner businessPartner = businessPartnerMock;
        
        // ... and a business partner service's mock that returns dummy entities
        when(businessPartnerMock
                .fetchBusinessPartnerAddress())
        .thenReturn(EntitySupplier.getDefaultListAddress());
        
        // When CustomBusinessPartnerService is called ...
        BusinessPartnerAddress address = testee.getBupaAddress(businessPartner);
