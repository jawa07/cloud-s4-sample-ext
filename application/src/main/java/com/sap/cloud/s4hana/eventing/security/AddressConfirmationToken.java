...
public final class AddressConfirmationToken implements Serializable {
	 ...
	 */
	public static final int NUMBER_OF_DAYS_VALID = 4;
	 ...
	 * @return {@link AddressConfirmationToken} with default validity period
	 * 
	 * @see AddressConfirmationToken#NUMBER_OF_DAYS_VALID
	 */
	public static final AddressConfirmationToken of(BusinessPartnerAddress address) {
		return new AddressConfirmationToken(address, NUMBER_OF_DAYS_VALID);
	}
