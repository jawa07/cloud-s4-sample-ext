        ...
        return UI5Object.extend("sap.enterpriseEventing.ui.controller.ErrorHandler", {
            ...
            _prepareErrorDetailsToShow: function (oDetails) {
                ...
                try {
                    ...
                    oErrorResponseText = JSON.parse(oDetails.responseText);

                    sErrorMessageParsed +=
                        "<strong>HTML Status Code:</strong> " + oErrorResponseText.status + "<br>" +
                        "<strong>Error:</strong> " + oErrorResponseText.error + "<br>" +
                        "<strong>Message:</strong> " + oErrorResponseText.message + "<br>" +
                        "<strong>Detailed Message:</strong> " + oErrorResponseText.detailMessage + "</p>";
                }
                catch (err) {
                    sErrorMessageParsed +=
