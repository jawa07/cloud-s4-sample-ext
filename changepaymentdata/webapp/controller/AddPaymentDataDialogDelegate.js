sap.ui.define([
...
], function (EventProvider, formatter, CustomDateType, Validator, ChooseCountryDialogDelegate) {
	"use strict";
	...
	return EventProvider.extend("com.sap.workflow.ChangePaymentData.controller.AddPaymentDataDialogDelegate", {
		...
		getNextBankIdentification : function (){
			...
			throw new Error("There cannot be more than 9999 bank in one Business Partner object.");
		},
		 ...
		 * @private
		 */
		constructor: function (oModel, oCountryModel, fnOnAfterSave) {
