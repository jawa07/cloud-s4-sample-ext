...
class DetailViewController: UITableViewController, SAPFioriLoadingIndicator, RefreshSectionViewDelegate {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> FUISimplePropertyFormCell {
        ...
        if let loadedProduct = product {
            ...
            // Basic Data Section
            case 0:
                let cell = tableView.dequeueReusableCell(withIdentifier: "ProductPropertyID", for: indexPath) as! FUISimplePropertyFormCell
                return cellForProductType(cell, indexPath: indexPath, currentEntity: loadedProduct)
                
            // Descriptions Section
            case 1:
                
                let cell = tableView.dequeueReusableCell(withIdentifier: "DescriptionID", for: indexPath) as! FUISimplePropertyFormCell
                return cellForDescriptionType(cell, indexPath: indexPath, currentEntity: loadedProduct)
                
            // Plants Section
            case 2:
                let cell = tableView.dequeueReusableCell(withIdentifier: "PlantID", for: indexPath) as! FUISimplePropertyFormCell
                return cellForPlantType(cell, indexPath: indexPath, currentEntity: loadedProduct)
                
            // Sales Section
            case 3:
                
                let cell = tableView.dequeueReusableCell(withIdentifier: "SaleID", for: indexPath) as! FUISimplePropertyFormCell
        ...
        let emptyCell = tableView.dequeueReusableCell(withIdentifier: "ProductPropertyID", for: indexPath) as! FUISimplePropertyFormCell
     ...
     */
    private func cellForProductType(_ cell: FUISimplePropertyFormCell!, indexPath: IndexPath, currentEntity: AProductType) -> FUISimplePropertyFormCell {
     ...
     */
    private func cellForDescriptionType(_ cell: FUISimplePropertyFormCell!,  indexPath: IndexPath, currentEntity: AProductType?) -> FUISimplePropertyFormCell {
     ...
     */
    private func cellForPlantType(_ cell: FUISimplePropertyFormCell!, indexPath: IndexPath, currentEntity: AProductType?) -> FUISimplePropertyFormCell {
     ...
     */
    private func cellForSalesType(_ cell: FUISimplePropertyFormCell!,  indexPath: IndexPath, currentEntity: AProductType?) -> FUISimplePropertyFormCell {
     ...
     */
    private func initializeCellWithDefaultConfigurations(_ cell: FUISimplePropertyFormCell, keyName: String, value: String) {
        cell.isEditable = false
    ...
    func setUpDetailView() {
        if let selectedProduct = productID {
            ...
            syncDetailView.notify(queue: .main) {
                self.tableContentView.register(FUISimplePropertyFormCell.self, forCellReuseIdentifier: "CellId")
