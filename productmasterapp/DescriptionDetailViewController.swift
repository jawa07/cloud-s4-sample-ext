...
class DescriptionDetailViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case .simplePropertyForm?:
            return CustomCellCreator.createSimplePropertyFormCell(tableView, indexPath: indexPath, cellId: CellTypeForCellIdentifier.simplePropertyForm.rawValue, cellKeyName: keyName, cellValue: value)
        case .keyValueForm?:
        ...
        return FUISimplePropertyFormCell()
    }
}
